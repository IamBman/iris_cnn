...
def main():
    ...
    fuse_list=[["conv1.0","conv1.1","conv1.2"],
          ["layer1.left.0","layer1.left.1","layer1.left.2"],
          ["layer1.left.3","layer1.left.4"],
          ["layer2.left.0","layer2.left.1","layer2.left.2"],
          ["layer2.left.3","layer2.left.4"],
          ["layer3.left.0","layer3.left.1","layer3.left.2"],
          ["layer3.left.3","layer3.left.4"]]
